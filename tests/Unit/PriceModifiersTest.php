...
class PriceModifiersTest extends ServiceTestCase
{
    ...
    public function test_DateRangeMultiplier_returns_a_correctly_modified_price(): void
    {
       // Given
        ...
        $promotion->setName('Black Frida half price sale');
     ...
     * @test
     */
    public function test_FixedPriceVoucher_returns_a_correctly_modified_price(): void
    {
        // Given
     ...
     * @test
     */
    public function test_EvenItemsMultiplier_correclty_calculates_alternatives(): void
    {
        // Given
        $enquiry = new LowestPriceEnquiry();
        $enquiry->setQuantity(5);
